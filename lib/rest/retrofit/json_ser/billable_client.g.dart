...
class _BillableClient implements BillableClient {
  ...
  Future<BillableJs> getBillable({
    ...
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<BillableJs>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = BillableJs.fromJson(_result.data!);
    return value;
  }
  ...
  @override
  Future<BillableJs> deleteBillable({required int id}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
