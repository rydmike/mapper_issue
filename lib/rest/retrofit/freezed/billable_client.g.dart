...
class _BillableClient implements BillableClient {
  ...
  Future<BillableFr> getBillable({
    ...
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<BillableFr>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = BillableFr.fromJson(_result.data!);
    return value;
  }
  ...
  @override
  Future<BillableFr> deleteBillable({required int id}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
